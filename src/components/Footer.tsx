...
export default function Footer() {
  return (
    <footer className="bg-[#F7F7F7] text-black py-12 px-6 border-t border-gray-200">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <a href="#" aria-label="LinkedIn"><Linkedin size={20} className="text-gray-600 hover:text-emerald-600 transition" /></a>
            <a href="#" aria-label="Facebook"><Facebook size={20} className="text-gray-600 hover:text-emerald-600 transition" /></a>
            <a href="#" aria-label="Instagram"><Instagram size={20} className="text-gray-600 hover:text-emerald-600 transition" /></a>
          </div>
        </div>
